...
class Converter(object):
    ...
    def encoder_spec(self):
      ...
      (parsed, columns, offsets, fixed_with_encoding, included_header, delimited_encoding) = get_metadata(self._specfile)
      result = (parsed, columns, offsets, fixed_with_encoding, included_header, delimited_encoding)
      if not parsed:
        return result
